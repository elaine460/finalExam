...
$sqlinsert = "SELECT * FROM tbl_cart WHERE user_email = '$useremail' AND subject_id = '$sjid' AND cart_status IS NULL";
...
{
    $addcart = "INSERT INTO `tbl_cart`(`user_email`,`subject_id`, `cart_qty`) VALUES ('$useremail','$sjid','$cartqty')";
...
$sqlgetqty = "SELECT * FROM tbl_cart WHERE user_email = '$useremail' AND cart_status IS NULL";
