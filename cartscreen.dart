...
import 'package:latesttutorapp/paymentscreen.dart';
...
class _CartScreenState extends State<CartScreen> {
  ...
  void _loadCart() {
    http.post(Uri.parse(MyConfig.server + "/mynewtutor/php/load_cart.php"),
        body: {
  ...
  _removeConfirmationDialog(int index) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
  ...
  void _deleteItem(int index) {
    http.post(Uri.parse(MyConfig.server + "/mynewtutor/php/delete_cart.php"),
        body: {
          //'user_email': widget.user.email,
  ...
  void _updateCart(int index, String s) {
    ...
    http.post(
        Uri.parse(MyConfig.server + "/mynewtutor/php/update_cart.php"), //edit
